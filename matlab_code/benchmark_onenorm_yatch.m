...
filename = 'yatch.xlsx'; % Replace with your Excel file name
if ~isfile(filename)
...
s = 2^35;              % Kernel parameter
c1 = 2^-2.8;           % Regularization parameter
...
for i = 1:length(lower_quantiles)
    ...
    tau_upper = 0.9 + tau_lower;  % Complement of lower quantile
...
% Save to CSV file
writetable(cell2table(results1), 'results_PI_onenorm_quantileLPONENORM_yatch.csv');
