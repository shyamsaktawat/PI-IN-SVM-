...
filename = 'winequality-red.csv'; % Replace with your Excel file name
if ~isfile(filename)
...
c1 = 2^-1;           % Regularization parameter
...
% Save to CSV file
writetable(cell2table(results1), 'results_PI_onenorm_quantileLPONENORM_red_wine.csv');
